(function() {
	...
	Tween = function() {
		...
		function exec(instance) {
	        var tween = instance.trans(instance.passed, instance.from, instance.to - instance.from, instance.duration);
	        instance.func(tween);
		}
	    ...
	    function destroy(){
	        ...
	        queue.splice(queue.indexOf ? queue.indexOf(me) : indexOf.call(_queue, me), 1);
	        me = null;
	    }
		...
		return function(cfg) {
	        ...
	        this.trans = cfg.trans || TweenFunc.Linear;
